...
#line 63 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 83 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 103 "trace/trace-target_arm_hvf.h"
    }
}
...
static inline void _nocheck__trace_hvf_data_abort(uint64_t va, uint64_t pa, bool isv, bool iswrite, bool s1ptw, uint32_t len, uint32_t srt)
{
...
#line 143 "trace/trace-target_arm_hvf.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_hvf_data_abort(va, pa, isv, iswrite, s1ptw, len, srt);
    }
}
...
#line 163 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 183 "trace/trace-target_arm_hvf.h"
    }
}
...
static inline void _nocheck__trace_hvf_unknown_hvc(uint64_t pc, uint64_t x0)
{
...
#line 203 "trace/trace-target_arm_hvf.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_hvf_unknown_hvc(pc, x0);
    }
}
...
#line 223 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 243 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 263 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 283 "trace/trace-target_arm_hvf.h"
    }
}
...
#line 303 "trace/trace-target_arm_hvf.h"
    }
}
...
static inline void _nocheck__trace_hvf_illegal_guest_state(void)
{
    if (trace_event_get_state(TRACE_HVF_ILLEGAL_GUEST_STATE) && qemu_loglevel_mask(LOG_TRACE)) {
#line 14 "../target/arm/hvf/trace-events"
        qemu_log("hvf_illegal_guest_state " "HV_ILLEGAL_GUEST_STATE" "\n");
#line 323 "trace/trace-target_arm_hvf.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_hvf_illegal_guest_state();
    }
}
