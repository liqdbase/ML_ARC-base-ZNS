...
static inline void _nocheck__trace_qio_channel_tls_bye_start(void * ioc)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_TLS_BYE_START) && qemu_loglevel_mask(LOG_TRACE)) {
#line 47 "../io/trace-events"
        qemu_log("qio_channel_tls_bye_start " "TLS termination start ioc=%p" "\n", ioc);
#line 898 "trace/trace-io.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_qio_channel_tls_bye_start(ioc);
    }
}
...
static inline void _nocheck__trace_qio_channel_tls_bye_pending(void * ioc, int status)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_TLS_BYE_PENDING) && qemu_loglevel_mask(LOG_TRACE)) {
#line 48 "../io/trace-events"
        qemu_log("qio_channel_tls_bye_pending " "TLS termination pending ioc=%p status=%d" "\n", ioc, status);
#line 918 "trace/trace-io.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_qio_channel_tls_bye_pending(ioc, status);
    }
}
...
static inline void _nocheck__trace_qio_channel_tls_bye_fail(void * ioc)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_TLS_BYE_FAIL) && qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (true) {
        _nocheck__trace_qio_channel_tls_bye_fail(ioc);
    }
}
...
static inline void _nocheck__trace_qio_channel_tls_bye_complete(void * ioc)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_TLS_BYE_COMPLETE) && qemu_loglevel_mask(LOG_TRACE)) {
#line 50 "../io/trace-events"
        qemu_log("qio_channel_tls_bye_complete " "TLS termination complete ioc=%p" "\n", ioc);
#line 958 "trace/trace-io.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_qio_channel_tls_bye_complete(ioc);
    }
}
...
static inline void _nocheck__trace_qio_channel_tls_bye_cancel(void * ioc)
{
    if (trace_event_get_state(TRACE_QIO_CHANNEL_TLS_BYE_CANCEL) && qemu_loglevel_mask(LOG_TRACE)) {
#line 51 "../io/trace-events"
        qemu_log("qio_channel_tls_bye_cancel " "TLS termination cancel ioc=%p" "\n", ioc);
#line 978 "trace/trace-io.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_qio_channel_tls_bye_cancel(ioc);
    }
}
