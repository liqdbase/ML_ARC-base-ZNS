...
static inline void _nocheck__trace_imx_i2c_read(const char * id, const char * reg, uint64_t ofs, uint64_t value)
{
    if (trace_event_get_state(TRACE_IMX_I2C_READ) && qemu_loglevel_mask(LOG_TRACE)) {
#line 62 "../hw/i2c/trace-events"
        qemu_log("imx_i2c_read " "%s:[%s (0x%" PRIx64 ")] -> 0x%02" PRIx64 "\n", id, reg, ofs, value);
#line 809 "trace/trace-hw_i2c.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_imx_i2c_read(id, reg, ofs, value);
    }
}
...
static inline void _nocheck__trace_imx_i2c_write(const char * id, const char * reg, uint64_t ofs, uint64_t value)
{
    if (trace_event_get_state(TRACE_IMX_I2C_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
#line 63 "../hw/i2c/trace-events"
        qemu_log("imx_i2c_write " "%s:[%s (0x%" PRIx64 ")] <- 0x%02" PRIx64 "\n", id, reg, ofs, value);
#line 829 "trace/trace-hw_i2c.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_imx_i2c_write(id, reg, ofs, value);
    }
}
