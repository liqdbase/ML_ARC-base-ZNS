...
static inline void _nocheck__trace_thread_pool_submit_aio(void * pool, void * req, void * opaque)
{
    if (trace_event_get_state(TRACE_THREAD_POOL_SUBMIT_AIO) && qemu_loglevel_mask(LOG_TRACE)) {
#line 17 "../util/trace-events"
        qemu_log("thread_pool_submit_aio " "pool %p req %p opaque %p" "\n", pool, req, opaque);
#line 429 "trace/trace-util.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_thread_pool_submit_aio(pool, req, opaque);
    }
}
...
static inline void _nocheck__trace_thread_pool_complete_aio(void * pool, void * req, void * opaque, int ret)
{
    if (trace_event_get_state(TRACE_THREAD_POOL_COMPLETE_AIO) && qemu_loglevel_mask(LOG_TRACE)) {
#line 18 "../util/trace-events"
        qemu_log("thread_pool_complete_aio " "pool %p req %p opaque %p ret %d" "\n", pool, req, opaque, ret);
#line 449 "trace/trace-util.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_thread_pool_complete_aio(pool, req, opaque, ret);
    }
}
...
static inline void _nocheck__trace_thread_pool_cancel_aio(void * req, void * opaque)
{
    if (trace_event_get_state(TRACE_THREAD_POOL_CANCEL_AIO) && qemu_loglevel_mask(LOG_TRACE)) {
#line 19 "../util/trace-events"
        qemu_log("thread_pool_cancel_aio " "req %p opaque %p" "\n", req, opaque);
#line 469 "trace/trace-util.h"
    }
}
...
{
    if (true) {
        _nocheck__trace_thread_pool_cancel_aio(req, opaque);
    }
}
