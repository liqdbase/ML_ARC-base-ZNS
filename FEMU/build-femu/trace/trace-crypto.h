...
static inline void _nocheck__trace_qcrypto_tls_session_parameters(void * session, int threadSafety, int protocol, int cipher)
{
    if (trace_event_get_state(TRACE_QCRYPTO_TLS_SESSION_PARAMETERS) && qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (true) {
        _nocheck__trace_qcrypto_tls_session_parameters(session, threadSafety, protocol, cipher);
    }
}
...
static inline void _nocheck__trace_qcrypto_tls_session_bug1717_workaround(void * session)
{
    if (trace_event_get_state(TRACE_QCRYPTO_TLS_SESSION_BUG1717_WORKAROUND) && qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (true) {
        _nocheck__trace_qcrypto_tls_session_bug1717_workaround(session);
    }
}
